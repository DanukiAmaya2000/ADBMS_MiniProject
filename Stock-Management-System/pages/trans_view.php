...
?>
<?php
  $query1="select getSubTotal('$tid') as sub_total";
  $subresult=mysqli_query($db, $query1) or die(mysqli_error($db));
  $sub_total_value=0;
  if($row=mysqli_fetch_assoc($subresult)){
    $sub_total_value=$row['sub_total'];
  }
?>
                  ...
                  <table width="100%">
                    <tr>
                      ...
                      <td class="text-right">Rs. <?php
                               echo number_format($sub_total_value,2);
                      ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Less VAT</td>
                      <td class="text-right">Rs. <?php echo $less; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Net of VAT</td>
                      <td class="text-right">Rs. <?php echo $net; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Add VAT</td>
                      <td class="text-right">Rs. <?php echo $add; ?></td>
                    </tr>
                    <tr>
